...
$query_datadosen = "SELECT * FROM dosen";
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="table-responsive">
                    ...
                    <td><?php echo $row_datadosen['nidn']; ?></td>
                    <td><?php echo $row_datadosen['nama']; ?></td>
                    <td><?php echo $row_datadosen['alamat']; ?></td>
                    <td><?php echo $row_datadosen['telp']; ?></td>
                    <td><a href="editdosen.php?kode_dosen=<?php echo $row_datadosen['kode_dosen']; ?>"><span class="badge badge-success px-2">Edit</span></a>
                    <a href="hapusdosen.php?kode_dosen=<?php echo $row_datadosen['kode_dosen']; ?>"><span class="badge badge-danger px-2">Hapus</span></a></td>
                  </tr>
