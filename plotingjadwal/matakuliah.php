...
$query_datadosen = "SELECT * FROM matakuliah";
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <a href="inputmatakuliah.php" type="button" class="btn mb-1 btn-primary">Input Data</a>
            <br>
            <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php do { ?>
                                           <tr>
                    <td><?php echo $row_datadosen['kode']; ?></td>
                    <td><?php echo $row_datadosen['kode_mk']; ?></td>
                    <td><?php echo $row_datadosen['nama']; ?></td>
                    <td><?php echo $row_datadosen['sks']; ?></td>
                    <td><?php echo $row_datadosen['semester']; ?></td>
                    <td><a href="editmatakuliah.php?kode=<?php echo $row_datadosen['kode']; ?>"><span class="badge badge-success px-2">Edit</span></a>
                    <a href="hapusmatakuliah.php?kode=<?php echo $row_datadosen['kode']; ?>"><span class="badge badge-danger px-2">Hapus</span></a></td>
                  </tr>
                  <?php } while ($row_datadosen = mysql_fetch_assoc($datadosen)); ?>
              </tbody>
              </table>
            </div>
            <!-- #/ container -->
