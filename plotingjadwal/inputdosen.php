...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO dosen (kode_dosen, nidn, nama, alamat, telp) VALUES (%s, %s, %s, %s, %s)",
            ...
            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
              <table align="center">
                <tr valign="baseline">
                  ...
                  <td><input type="text" name="kode_dosen" value="" size="32"></td>
                </tr>
                <tr valign="baseline">
                  <td nowrap align="right">Nidn:</td>
                  <td><input type="text" name="nidn" value="" size="32"></td>
                </tr>
                <tr valign="baseline">
                ...
                <tr valign="baseline">
                  ...
                  <td><input type="submit" value="Simpan"  class="btn mb-1 btn-danger"></td>
                </tr>
              </table>
